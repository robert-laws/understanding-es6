...
/***/ function(module, exports, __webpack_require__) {
	...
	var _items = __webpack_require__(299);
	...
	(0, _jquery2.default)('<h1>Items...</h1>').appendTo('body');
	...
	try {
	  for (var _iterator = _items2.default[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var item = _step.value;

	    (0, _jquery2.default)('<li></li>').text(item).appendTo(ul);
	  }
	} catch (err) {
